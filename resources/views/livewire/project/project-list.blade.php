<div class="py-4 space-y-4">
    ...
    <div class="flex justify-between">
        <div class="w-2/4 flex space-x-4">
            @include('livewire.shared.search', ['subject' => 'projects'])
        </div>
    ...
    <div class="flex-col space-y-6">
        ...
        <x-table>
            <x-slot name="head">
                ...
                <x-table.heading class="dark:bg-gray-900">Images</x-table.heading>
                <x-table.heading class="dark:bg-gray-900"></x-table.heading>
                <x-table.heading class="dark:bg-gray-900"></x-table.heading>
                <x-table.heading class="dark:bg-gray-900"></x-table.heading>
                <x-table.heading class="dark:bg-gray-900"></x-table.heading>
            ...
            <x-slot name="body">
                ...
                @forelse($projects as $project)
                    <x-table.row wire:loading.class.delay="opacity-50" wire:key="row-{{ $project->id }}">
                        ...
                        <x-table.cell>
                            <img src="{{ asset('img/'. $project->image_1) }}" alt="" class="h-5">
                        </x-table.cell>
                        <x-table.cell>
                            <img src="{{ asset('img/'. $project->image_2) }}" alt="" class="h-5">
                        </x-table.cell>
                        <x-table.cell>
                            <img src="{{ asset('img/'. $project->image_3) }}" alt="" class="h-5">
                        </x-table.cell>
                        <x-table.cell>
                            <img src="{{ asset('img/'. $project->image_4) }}" alt="" class="h-5">
                        </x-table.cell>
                        <x-table.cell>
                            <img src="{{ asset('img/'. $project->image_5) }}" alt="" class="h-5">
                        </x-table.cell>
                        <x-table.cell>
