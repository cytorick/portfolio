                        ...
                        <div class="col-span-5">
                            <x-input.group stacked for="contract_type" label="{{ __('Contract Type*') }}"
                                ...
                                <x-input.select id="contract_type" wire:model="editing.contract_type"
                                                :error="$errors->first('editing.contract_type')" placeholder="{{__('Select contract type')}}">
                    ...
                    <div class="grid grid-cols-9 gap-5">
                        <div class="col-span-5">
                            <x-input.group stacked for="street" label="Street"
                                           :error="$errors->first('editing.street')">
                ...
                <div class="border-t border-green-600 px-4 py-5 sm:px-6 space-y-4">
                    <div class="grid grid-cols-9 gap-5">
                        ...
                        <div class="col-span-5">
                            <div>
                                <label for="end_date"
                                       class="block text-sm font-medium text-gray-700 dark:text-gray-200">End
                                    date</label>
                                <div class="mt-1">
