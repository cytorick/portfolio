<section class="bg-gray-100 dark:bg-gray-800">
                    ...
                    <div class="sm:text-center lg:text-left">
                        ...
                        <p class="mt-3 text-base text-gray-500 dark:text-gray-200 sm:mt-5 sm:text-lg sm:max-w-xl sm:mx-auto md:mt-5 md:text-xl lg:mx-0">
                            I am a {{ $age }} year-old <span
                                class="text-error">Full-Stack development</span> student from The Netherlands.
                        </p>
                        <p class="mt-3 text-base text-gray-500 dark:text-gray-200 sm:mt-5 sm:text-lg sm:max-w-xl sm:mx-auto md:mt-5 md:text-xl lg:mx-0">
                            If I have to describe my self I would say that I am <span class="text-red-400">"Inquisitive, innovative &
                            stress-resistant"</span>. I am a very social guy. I like to chat with co-workers and maybe drink a
                            beer with some of my co-workers.
                        </p>
                        <p class="mt-3 text-base text-gray-500 dark:text-gray-200 sm:mt-5 sm:text-lg sm:max-w-xl sm:mx-auto md:mt-5 md:text-xl lg:mx-0">
                            Did you get <span class="text-red-400">enthusiastic</span>, contact me! <span class="text-red-400">:)</span>
                        </p>
        ...
        <div class="max-w-7xl mx-auto py-12 px-4 sm:px-6 lg:py-16 lg:px-8">
            <div class="lg:grid lg:grid-cols-2 lg:gap-8 lg:items-center">
                <div class="mt-8 grid grid-cols-2 gap-0.5 md:grid-cols-3 lg:mt-0 lg:grid-cols-2">
                    <div class="col-span-2 flex justify-center py-8 px-8 bg-gray-200 dark:bg-transparent">
                        <div class="flow-root">
                                        ...
                                        <span
                                         ...
                                         <i class="fa-solid fa-code"></i>
                                            ...
                                            <div class="min-w-0 flex-1 pt-1.5 flex justify-between space-x-4 pl-2">
                                                <div>
                                                    <p class="text-sm text-gray-500 dark:text-gray-200">Started my
                                    ...
                                    <li>
                                        <div class="relative pb-8">
                                            ...
                                            <div class="relative flex space-x-3">
                                                ...
                                                <div class="min-w-0 flex-1 pt-1.5 flex justify-between space-x-4 pl-2">
                                                    <div>
                                                        <p class="text-sm text-gray-500 dark:text-gray-200">Got my first
                                                            internship at
                                                            @if($internship->company == 'Custom Website')
                                                                <span class="text-orange-500">Custom</span> <span
                                                                    class="dark:text-white text-black">Website</span>!
                                                            @elseif($internship->company == 'Praes')
                                                                <span class="text-sky-500">Praes</span>!
                                                            @endif</p>
                                                    </div>
                                                    <div
                                                        class="text-right text-sm whitespace-nowrap text-gray-500 dark:text-gray-300">
                                    ...
                                    <div class="relative pb-8">
                                        ...
                                        <span
                                         ...
                                         <i class="fa-solid fa-clipboard-question"></i>
                                            ...
                                            <div class="min-w-0 flex-1 pt-1.5 flex justify-between space-x-4 pl-2">
                                                <div>
                                                    <p class="text-sm text-gray-500 dark:text-gray-200">Your company,
                                                        maybe?</p>
                                                </div>
                                                <div
                                                    class="text-right text-sm whitespace-nowrap text-gray-500 dark:text-gray-300">
                ...
                <div>
                    <h2 class="text-3xl font-extrabold text-gray-900 sm:text-4xl"><span
                            class="block text-gray-900 dark:text-gray-100">How I started my programming <span
                                class="text-error">journey</span></span>
                    </h2>
                    <p class="mt-3 max-w-3xl text-lg text-gray-50 dark:text-gray-2000">
                        I started my journey when I was 18 years old. I had just picked a study which I didn't like and
                        was looking for a new study when I stumbled across <span class="text-red-400">"Software Development"</span>.
                        I was immediately
            ...
            <div class="lg:grid lg:grid-cols-2 lg:gap-8 lg:items-center">
                <div>
                    <h2 class="text-3xl font-extrabold text-gray-900 sm:text-4xl dark:text-gray-100">The <span
                            class="text-error">skills</span> I have learned over the years</h2>
                    <p class="mt-3 max-w-3xl text-lg text-gray-500 dark:text-gray-200">Over the years I have collected a
                        few <span class="text-error">skills</span>. I have learned these <span
                            class="text-error">skills</span> at school, at a <span class="text-error">job</span> or at
                        an <span class="text-error">internship</span>. These <span class="text-error">skills</span>
                        range from a basic state to a more advanced state.</p>
                    <p class="mt-3 max-w-3xl text-lg text-gray-500 dark:text-gray-200">I would say that in programming
                        <span class="text-red-500"><i class="fa-brands fa-laravel"></i> Laravel</span> is the <span
                            class="text-error">skill</span> I am most proud of. I luckily got the chance the past years
                        to get better at <span class="text-red-500"><i class="fa-brands fa-laravel"></i> Laravel</span>
                        and learn a lot of things I didn't expect to learn.</p>
                    <p class="mt-3 max-w-3xl text-lg text-gray-500 dark:text-gray-200">See here what I have made with
                        these skills.</p>
    ...
    @include('livewire.about.languages')
