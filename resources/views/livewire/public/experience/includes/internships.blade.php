    ...
    <div class="mx-auto max-w-7xl py-12 px-4 sm:px-6 lg:px-8 lg:py-24">
        <div class="grid grid-cols-1 gap-12 lg:grid-cols-3 lg:gap-8">
            <div class="space-y-5 sm:space-y-4">
                <h2 class="text-3xl font-bold tracking-tight sm:text-4xl text-gray-900">Waar ik stage heb gelopen</h2>
                <p class="text-xl text-gray-500">Vanuit mijn opleidingen heb ik stage moeten lopen en dit heb ik gedaan bij de volgende bedrijven.</p>
            </div>
                        ...
                        <li>
                            <div class="flex items-center space-x-4 lg:space-x-6">
                                ...
                                <div class="space-y-1 text-lg font-medium leading-6">
                                    <h3 class="text-gray-900">{{ $internship->name }}</h3>
