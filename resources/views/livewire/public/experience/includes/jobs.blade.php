    ...
    <div class="mx-auto max-w-7xl py-12 px-4 sm:px-6 lg:px-8 lg:py-24">
        <div class="grid grid-cols-1 gap-12 lg:grid-cols-3 lg:gap-8">
            <div class="space-y-5 sm:space-y-4">
                <h2 class="text-3xl font-bold tracking-tight sm:text-4xl text-gray-900">Waar ik gewerkt heb</h2>
                <p class="text-xl text-gray-500">Door de jaren heen heb ik verscheiden banen/bijbanen gehad. Deze ervaring varieert tussen een bijbaan als winkelmedewerker/hulpkracht tot developer.</p>
            </div>
                        ...
                        <li>
                            <div class="flex items-center space-x-4 lg:space-x-6">
                                ...
                                <div class="space-y-1 text-lg font-medium leading-6">
                                    <h3 class="text-gray-900">{{ $job->function }}</h3>
