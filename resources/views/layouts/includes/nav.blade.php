...
Heroicon name: outline/x" x-state:on="Menu open" x-state:off="Menu closed" class="hidden h-6 w-6"
    ...
    <nav x-description="Mobile menu, show/hide based on menu state." class="lg:hidden __WebInspectorHideElement__"
        ...
        <div class="pt-2 pb-3 px-2 space-y-1">
            ...
            <a href="{{ route('home') }}" class="{{ (request()->is('/')) ? 'bg-red-400 text-white block rounded-md py-2 px-3 text-base font-medium' : 'bg-gray-800 text-gray-300 hover:bg-gray-700 hover:text-white block rounded-md py-2 px-3 text-base font-medium' }}"
               aria-current="page" x-state:on="Current" x-state:off="Default"
               x-state-description="Current: &quot;bg-gray-900 text-white&quot;, Default: &quot;text-gray-300 hover:bg-gray-700 hover:text-white&quot;">Home</a>

            <a href="{{ route('about') }}" class="{{ (request()->is('about*')) ? 'bg-red-400 text-white block rounded-md py-2 px-3 text-base font-medium' : 'bg-gray-800 text-gray-300 hover:bg-gray-700 hover:text-white block rounded-md py-2 px-3 text-base font-medium' }}"
               aria-current="page" x-state:on="Current" x-state:off="Default"
               x-state-description="undefined: &quot;bg-gray-900 text-white&quot;, undefined: &quot;text-gray-300 hover:bg-gray-700 hover:text-white&quot;">About me</a>
