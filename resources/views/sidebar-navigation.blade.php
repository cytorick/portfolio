<x-sidenav>
    <x-sidenav.item href="{{ route('dashboard') }}" :active="request()->routeIs('dashboard')">
    ...
    <x-sidenav.item href="{{ route('admin.projects') }}"
    ...
    <x-sidenav.item href="{{ route('admin.certificates') }}"
    ...
    <x-sidenav.item href="{{ route('admin.jobs') }}"
                    :active="request()->routeIs('admin.jobs', 'admin.create.jobs', 'admin.edit.jobs')">
        <div class="mr-4 flex-shrink-0">
            <svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" stroke-width="1.5"
                 stroke="currentColor" class="w-6 h-6">
                <path stroke-linecap="round" stroke-linejoin="round"
    ...
    <x-sidenav.item href="{{ route('admin.internships') }}"
    ...
    <x-sidenav.item href="{{ route('admin.schools') }}"
                    :active="request()->routeIs('admin.schools', 'admin.create.schools', 'admin.edit.schools')">
        <div class="mr-4 flex-shrink-0">
            <svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" stroke-width="1.5"
                 stroke="currentColor" class="w-6 h-6">
                <path stroke-linecap="round" stroke-linejoin="round"
    ...
    <x-sidenav.dropdown-button
        ...
        <x-slot name="content">
            <x-sidenav.dropdown-item href="{{ route('admin.languages') }}"
            ...
            <x-sidenav.dropdown-item href="{{ route('admin.skills') }}"
                                     :active="request()->routeIs('admin.skills', 'admin.edit.skills', 'admin.create.skills')">
                <div class="mr-4 ml-4 flex-shrink-0">
                    <svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" stroke-width="1.5"
                         stroke="currentColor" class="w-6 h-6">
                        <path stroke-linecap="round" stroke-linejoin="round"
            ...
            <x-sidenav.dropdown-item href="{{ route('admin.texts') }}"
                                     :active="request()->routeIs('admin.texts', 'admin.edit.texts')">
                <div class="mr-4 ml-4 flex-shrink-0">
                    <svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" stroke-width="1.5"
                         stroke="currentColor" class="w-6 h-6">
                        <path stroke-linecap="round" stroke-linejoin="round"
    ...
    <x-sidenav.item class="text-green-600 hover:text-gray-50" href="{{ route('home') }}">
        <div class="mr-4 flex-shrink-0">
            <svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" stroke-width="1.5"
                 stroke="currentColor" class="w-6 h-6">
                <path stroke-linecap="round" stroke-linejoin="round"
    ...
    <span x-tooltip.raw="Tasks"
          onclick="openNav()">
        <x-sidenav.item class="text-yellow-600 hover:text-gray-50">
            <div class="mr-4 flex-shrink-0">
