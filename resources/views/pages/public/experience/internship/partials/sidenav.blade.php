<aside class="col-span-1 mb-10">
    <nav class="mt-0" aria-label="Sidebar">
        ...
        <x-nav.sidebar-item class="text-black bg-gray-200 hover:bg-gray-300 dark:bg-gray-900 dark:hover:bg-gray-700 dark:text-gray-200 hover:text-green-600 {{ (request()->is('experience/internships/'. $internship->id .'/overview')) ? 'dark:bg-green-600 bg-green-600' : '' }}" href="{{ route('internships.show', [ 'internshipId' => $internship->id, 'page' => 'overview' ]) }}">
            {{ __('Overview') }}
        </x-nav.sidebar-item>
