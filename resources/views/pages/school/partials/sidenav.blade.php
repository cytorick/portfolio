<aside class="col-span-1">
    <nav class="mt-0" aria-label="Sidebar">
        ...
        <x-nav.sidebar-item class="text-black bg-gray-200 hover:bg-gray-300 dark:bg-gray-900 dark:hover:bg-gray-700 dark:text-gray-200 hover:text-red-400 {{ (request()->is('experience/school/'. $school->id .'/overview')) ? 'dark:bg-red-400 bg-red-400' : '' }}" href="{{ route('school.show', [ 'schoolId' => $school->id, 'page' => 'overview' ]) }}" :active="request()->is('*/overview')">
            {{ __('Overview') }}
        </x-nav.sidebar-item>

        <x-nav.sidebar-item class="text-black bg-gray-200 hover:bg-gray-300 dark:bg-gray-900 dark:hover:bg-gray-700 dark:text-gray-200 hover:text-red-400 {{ (request()->is('experience/school/'. $school->id .'/what-I-learned')) ? 'dark:bg-red-400 bg-red-400' : '' }}" href="{{ route('school.show', [ 'schoolId' => $school->id, 'page' => 'what-I-learned' ]) }}" :active="request()->is('*/overview')">
            {{ __('What I learned') }}
        </x-nav.sidebar-item>
