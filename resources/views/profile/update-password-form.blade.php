<x-jet-form-section submit="updatePassword">
    ...
    <x-slot name="form">
        <div class="col-span-6 sm:col-span-4">
            <x-jet-label for="current_password" class="dark:text-gray-400" value="{{ __('Current Password') }}" />
{{--            <x-jet-input id="current_password" type="password" class="mt-1 block w-full" wire:model.defer="state.current_password" autocomplete="current-password" />--}}
        ...
        <div class="col-span-6 sm:col-span-4">
            <x-jet-label for="password" class="dark:text-gray-400" value="{{ __('New Password') }}" />
{{--            <x-jet-input id="password" type="password" class="mt-1 block w-full" wire:model.defer="state.password" autocomplete="new-password" />--}}
        ...
        <div class="col-span-6 sm:col-span-4">
            <x-jet-label for="password_confirmation" class="dark:text-gray-400" value="{{ __('Confirm Password') }}" />
